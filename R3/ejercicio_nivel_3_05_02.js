/* 
Tips: la funcion toUpperCase() de javascript devuelve un valor convertido en mayúscula de la 
cadena (string) que realiza la llamada.
Ej: "Diplo".toUpperCase() retorna "DIPLO".
I) Si al ejecutar el código ingresás alguno de los siguientes letras (minúsculas): 
a - e - i - o - u, te parece que el código está respondiendo bien?
Si te parece que algo no está bien, podrás corregirlo para que funcione con esas letras?
II) Ahora si quiero ingresar las vocales en mayúscula (A-E-I-O-U), el código te responde 
correctamente? Si te parece que no, podés modificarlo para que contemple estos casos? 
*/
